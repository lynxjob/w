Ext.namespace('Long');
Long.ProviderGrid = Ext.extend(Long.BaseGeneralGrid, {
	id:'providergrid',
	title:'供应商信息管理',
	baseUrl:'provider!list',
	pageSize : 30,
	initComponent : function() {
		...
		Long.ProviderGrid.superclass.initComponent.call(this);
	},
    ...
    deleteOp : function(){
        ...
        Ext.Msg.confirm('系统提示', '确定要删除所选供应商吗？', function(btn){
            if (btn == 'yes') {
                Ext.Ajax.request({
                    url : 'provider!delete',
                    scope : this,
